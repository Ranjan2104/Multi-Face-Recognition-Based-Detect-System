...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'ranjan.amresh100@gmail.com' ")
...
window.title("Multi-Faces Recognition System")
window.configure(background='#262523')
window.iconphoto(False, tk.PhotoImage(file = 'C:/Users/Amresh Ranjan/Desktop/Plannings/OpenCV Projects/Multi-Face Recognition Based Detect System/facial-recognition.png'))
...
message3 = tk.Label(window, text="Multi-Face Recognition Based Detect System" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
...
lbl = tk.Label(frame2, text="Enter ID(Numeric Values)",width=20  ,height=1  ,fg="black"  ,bg="#00aeff" ,font=('times', 17, ' bold ') )
lbl.place(x=80, y=55)

txt = tk.Entry(frame2,width=32 ,fg="black",font=('times', 15, ' bold '))
txt.place(x=30, y=88)

lbl2 = tk.Label(frame2, text="Enter Your Name",width=20  ,fg="black"  ,bg="#00aeff" ,font=('times', 17, ' bold '))
lbl2.place(x=80, y=140)

txt2 = tk.Entry(frame2,width=32 ,fg="black",font=('times', 15, ' bold ')  )
txt2.place(x=30, y=173)

message1 = tk.Label(frame2, text="1)Ready for Take Images  >>>  2)Save Profile" ,bg="#00aeff" ,fg="black"  ,width=39 ,height=1, activebackground = "yellow" ,font=('times', 15, ' bold '))
message1.place(x=7, y=230)

message = tk.Label(frame2, text="" ,bg="#00aeff" ,fg="black"  ,width=39,height=1, activebackground = "yellow" ,font=('times', 16, ' bold '))
message.place(x=7, y=450)

lbl3 = tk.Label(frame1, text="Total Detections Shows!",width=20  ,fg="white"  ,bg="#00aeff"  ,height=1 ,font=('times', 17, ' bold '))
...
takeImg = tk.Button(frame2, text="Take Images Now", command=TakeImages  ,fg="white"  ,bg="blue"  ,width=34  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
takeImg.place(x=30, y=300)
trainImg = tk.Button(frame2, text="Save Your Profile", command=psw ,fg="white"  ,bg="purple"  ,width=34  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
trainImg.place(x=30, y=380)
trackImg = tk.Button(frame1, text="Recognizes Your Faces Now", command=TrackImages  ,fg="black"  ,bg="yellow"  ,width=35  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
